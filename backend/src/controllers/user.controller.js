...
export async function getMyFriends(req,res){
    try{
        ...
        .select('friends')
        .populate('friends', 'fullName profilePic nativeLanguage learningLanguage');  //select- only gives the id but populate - gives whole info of friends
...
export async function acceptFriendRequest(req,res){
    try{
        ...
        //add each user to the other friend's array
